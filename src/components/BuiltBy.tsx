...
const BuiltBy = () => {
  return (
    <section className="max-w-6xl p-5">
      <div className="flex flex-col lg:flex-row items-center gap-8 md:mb-14 lg:p-0">
        <div>
          <HoverBorderGradient
          ...
          <p className="text-base text-left tracking-wider leading-8 mt-5 mb-10 text-muted-foreground">
            ...
            help you excel. From coding advice to real-world project
            experiences, whether you&apos;re a beginner or a pro, you&apos;ll
            find valuable resources for your development journey.
          </p>
          <Link href="/careers/career-pathways">
            <MagicButton
